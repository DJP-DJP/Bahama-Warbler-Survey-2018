...
t.test(EE_Lucayan_presences$Girth_average, FP_WE$Girth_average) # DiscM NOT significantly different p=0.8
...
wilcox.test(EE_Lucayan_presences$DiscM, FP_WE$DiscM) # DBH NOT significantly different P=0.56 # Matches parametric test
